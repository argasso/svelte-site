...
<script>
  ...
  export let isbn //: Book['isbn']
  export let generalDetails //: Book_generalDetails
  export let audioDetails //: Book_audioDetails
  export let translationDetails //: Book_translationDetails
  // export let seo //: string

  /** @type {import("src/types").LinkInfo[]} */
  export let authors = []
