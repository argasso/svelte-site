    ...
    <div class="w-full md:w-2/5 p-10 md:p-10 lg:p-10 max-w-sm md:max-w-xs">
      <svg
        ...
        <path
          ...
          fill="#4db6ac"
          opacity="0.1" />
        <ellipse cx="201.95" cy="781.59" rx="22.99" ry="2.57" fill="#4db6ac" opacity="0.1" />
        <ellipse cx="51.24" cy="737.91" rx="22.99" ry="2.57" fill="#4db6ac" opacity="0.1" />
        <ellipse cx="316.83" cy="810.6" rx="22.99" ry="2.57" fill="#4db6ac" opacity="0.1" />
        <ellipse cx="905.53" cy="747.41" rx="22.99" ry="2.57" fill="#4db6ac" opacity="0.1" />
        <ellipse cx="714.22" cy="734.94" rx="22.99" ry="2.57" fill="#4db6ac" opacity="0.1" />
        <ellipse cx="590.46" cy="793.66" rx="27.19" ry="4.67" fill="#4db6ac" opacity="0.1" />
        <path
        ...
        <path
          ...
          transform="translate(-88.58 -43.42)"
          fill="#ffd037" />
        <ellipse cx="933.75" cy="716.37" rx="62" ry="9.51" fill="#4db6ac" opacity="0.1" />
        <path
